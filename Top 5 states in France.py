...
#Getting top 5 places in FRANCE with most number of injuries
maskcan =  (data2[:,5] == 'France')
#fetching data from csv file regarding locations in FRANCE with most injuries in accident.col[4]
...
#Top 5 states in FRANCE with most number of injuries.
...
plt.bar(y_position_2, top_5_can.values(), align='center', alpha=0.5, color='r')

plt.xticks(y_position_2, top_5_can.keys(), rotation=0)

plt.ylabel('FREQUENCY OF INJURY/STATE')

plt.title('TOP 5 STATES IN FRANCE WITH MAX INJURIES')

#plt.savefig('INJURY FREQUENCY VS STATE:France.png', bbox_inches='tight')
